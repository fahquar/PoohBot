...
class FuckingDinner(callbacks.Plugin):
    ...
    def fuckingdinner(self, irc, msg, args, opts):
        ...
        What the fuck should I make for dinner? Pulls a random receipe from http://whatthefuckshouldimakefordinner.com
        If --veg is given, a vegetarian meal will be selected. If --drink is given, a drink will be selected."""
...
#            out = ircutils.bold(out)
    ...
    fuckingdinner = wrap(fuckingdinner, [getopts({'veg': '','drinks': ''})])
