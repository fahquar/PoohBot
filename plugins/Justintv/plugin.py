...
class _Plugin(callbacks.Plugin):
    ...
    threaded = True
    def twitch(self, irc, msg, args, things):
        """ <channel> [<channel> ...]
    ...
    twitch = wrap(twitch, [additional('anything')])

    
    def livestream(self, irc, msg, args, things):
        """ <channel> [<channel> ...]
        ...
        if out:
            ...
            irc.reply('No current live streams.')
    livestream = wrap(livestream, [additional('anything')])
